...
public class Request implements Serializable {
    ...
    private final Collection<? extends Entry<String, ?>> headers;
    private final Collection<? extends Entry<String, ?>> cookies;
    private final Collection<? extends Entry<String, ?>> params;
     ...
     */
    @Deprecated
    public Collection<? extends Entry<String, ?>> getHeaders() {
        return headers;
    }
     ...
     */
    @Deprecated
    public Collection<? extends Entry<String, ?>> getCookies() {
        return cookies;
    }
     ...
     */
    @Deprecated
    public Collection<? extends Entry<String, ?>> getParams() {
        return params;
    }
